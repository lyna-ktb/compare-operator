    ...
    <section class="products-gallery padding-y-lg">
        <div class="container max-width-adaptive-md">
          ...
          -->
                ...
                $alltour = $tourManag->getList();
                foreach ($alltour as $onetour) { 
                    ...
                    <div class="prod-card col-4@md">
                        ...
                        <a class="prod-card__img-link" href="destiByTo.php?id=<?=$onetour->getId()?>" aria-label="Description of the link">
                            <figure class="prod-card__img ">
                                <img src="../<?= $onetour->getLogo() ?>" alt="Product preview image">
                            </figure>
                        </a>

                        <div class="padding-sm text-center">
                            <h3><a class="color-inherit" href="destiByTo.php?id=<?=$onetour->getId()?>"><?= $onetour->getName() ?></a></h3>

                            <!--<div class="margin-top-xs">
                                    <span class="prod-card__price"><?/*=$onedest->getPrice()*/ ?> €</span>
                                </div>-->
                        </div>
                    </div>
