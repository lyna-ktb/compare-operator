    ...
    <main class="background-video">
       ...
       -->
        ...
        <section class="products-gallery padding-y-lg">
            <div class="container max-width-adaptive-md">
                <div class="margin-bottom-lg">
                    <div class="flex justify-center items-end justify-between@md">
                        ...
                        <?php
                        $tour= new Tour_operators([
                            'id'=>$_GET['id']
                        ]);

                        $toManager = new  Tour_operatorsManager($bdd);
                        $toManager->getOnById($tour);
                        ?>

                        <h1><?=ucfirst($tour->getName())?></h1>
                    </div>
                </div>
          ...
          -->
                    <?php
                    $destManag = new DestinationManager($bdd);

                    $alldest = $destManag->getDestinationByTo($tour);
                    foreach ($alldest as $onedest){ ?>
                        ...
                        <div class="prod-card col-4@md">
                            ...
                            <a class="prod-card__img-link" href="#0" aria-label="Description of the link">
                                <figure class="prod-card__img ">
                                    <img src="../<?=$onedest->getImg()?>" alt="Product preview image">
                                </figure>
                            </a>

                            <div class="padding-sm text-center">
                                <h3><a class="color-inherit" href="#0"><?=$onedest->getLocation()?></a></h3>
