...
<header class="video-header">
    ...
    <div class="viewport-header">
        <div class="text-component text-center line-height-lg v-space-md margin-bottom-md">
            ...
            <p class="color-medium text-md" style="color: white;">qu'on achète qui nous rend plus riche.</p>
        </div>
    </div>
</header>
    ...
    <div class="container max-width-adaptive-md">
        <div class="margin-bottom-lg">
            <div class="flex justify-center items-end justify-between@md">
                <h1>Les meilleurs tour opérateur</h1>
            </div>
        </div>
      ...
      -->
            <?php
            $tourmanag=new Tour_operatorsManager($bdd);
            $allBest = $tourmanag->getBestTo();
            foreach ($allBest as $onebest){
                $best_destination = $tourmanag->getBestPrice($onebest)
                ?>

                <div class="prod-card col-4@md">
                    <span class="prod-card__badge" role="text">New <i class="sr-only">product</i></span>

                    <a class="prod-card__img-link" href="views/destiByTo.php?id=<?=$onebest->getId()?>" aria-label="Description of the link">
                        <figure class="prod-card__img ">
                            <img src="<?=$onebest->getLogo()?>" alt="Product preview image">
                        </figure>
                    </a>
            ...
            <section class="position-relative z-index-1 padding-y-xl">
                <div class="container max-width-adaptive-lg">
                    <div class="margin-bottom-xl">
                        <h1 class="text-center">Découvrez nos voyages</h1>
                    </div>
                    <div class="grid gap-xxl">
                        ...
                        <?php
                           $destination = new DestinationManager($bdd);
                            ...
                            foreach ($allDestinations as $lineDestination){
                        ?>
                        ...
                        <div class="card-v13 col-12 col-6@md col-4@lg">
                            ...
                            <div class="text-center margin-top-sm">
                                <h3 class="text-md">
                                    <a class="color-contrast-higher" href="views/destiListe.php?destination=<?=$lineDestination->getLocation()?>"><?=$lineDestination->getLocation()?></a>
                                </h3>

                                <div class="card-v13__separator margin-x-auto margin-y-sm" role="presentation"></div>

                                <p class="color-contrast-medium text-sm line-height-lg"><?=$lineDestination->getDescri()?></p>

                                <div class="margin-top-sm">
                                    <button class="reset btn-fx-3 radius-md text-sm">
                                            ...
                                            <figure class="btn-fx-3__icon-wrapper" aria-hidden="true">
                                                <svg class="icon icon--xs" viewBox="0 0 16 16">
                                                    ...
                                                    <g stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path d="M8 11.5h7.5"></path>
                                                        <path d="M13 9l2.5 2.5L13 14"></path>
                                                        <path d="M.5 5.5h15"></path>
                                                        <path d="M15.5 8.5V4A1.5 1.5 0 0 0 14 2.5H2A1.5 1.5 0 0 0 .5 4v9A1.5 1.5 0 0 0 2 14.5h7.5"></path>
                                                        <path d="M4.5.5v2"></path>
                                                        <path d="M11.5.5v2"></path>
                                                    </g>
                                                </svg>
                                            </figure>
                                        </div>
